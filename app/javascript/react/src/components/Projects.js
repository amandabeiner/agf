    ...
    <div className="project-tile-container row">
      ...
      <div className="project small-12 medium-6 columns">
        ...
        <p className="project-text">
          ...
          <p>This essay, which has been selected for inclusion in a planned collection, <i>The Intimate State: Gender, Sexuality, and Governance in Modern U.S. History</i> collection edited by Margot Canaday, Nancy Cott, and Robert Self</p>
          </p> 
      </div>
      <div className="project small-12 medium-6 columns">
